...
import { joinSession, waitForBothPlayers, leaveSession } from "./api";
...
export default function App() {
  ...
  async function handlePlayAgain() {
    // Tear down the backend session so a fresh one can be created on rejoin.
    // leaveSession swallows errors internally, so this is safe to await blindly.
    await leaveSession();
    setSession(null);
    setGameResult(null);
    setPhase("lobby");
